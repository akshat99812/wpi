...
export const STATE_PROFILES: Record<string, StateWindProfile> = {
  ...
  'Andhra Pradesh': {
    ...
    intro: "Andhra Pradesh's rain-shadow Anantapur–Kurnool belt is among India's most productive wind terrain. With ~4.38 GW installed and 123.34 GW of NIWE 150 m potential, the state carries strong procurement momentum under APEPDCL tenders and SECI ISTS tranches.",

    resourceGeography: [
      "AP's prime corridor runs from Anantapur — one of India's driest districts — through Kurnool and into coastal Nellore. NIWE places the 150 m potential at 123.34 GW (MNRE Table 7.1). Wind speeds in the Anantapur–Kurnool rain-shadow reach 7.5–8.5 m/s at hub height.",
  ...
  'Gujarat': {
    ...
    resourceGeography: [
      "Gujarat's wind resource anchors on the Kutch–Saurashtra coastal belt and the Thar Desert margin. The NIWE 150 m potential is 180.79 GW — second-largest state endowment after Rajasthan. Kutch wind speeds regularly exceed 8 m/s at hub height; the Adani-dominated Khavda cluster hosts Class 6–7 sites.",
  ...
  'Karnataka': {
    ...
    intro: "Karnataka holds ~169.25 GW of NIWE 150 m wind potential — the fourth-largest state endowment nationally — yet only ~4.3% is built out. The Chitradurga–Gadag–Davangere ridgeline is India's densest wind development corridor and anchors the OEM manufacturing hub (Inox, Vestas).",

    resourceGeography: [
      "Karnataka's wind resource runs along the Deccan plateau ridgelines from Chitradurga through Gadag, Davangere and Tumkur. NIWE places the 150 m potential at 169.25 GW (MNRE Table 7.1) — fourth-largest nationally, after Rajasthan, Gujarat and Maharashtra. Best ridgeline sites record 7.5–9 m/s at hub height.",
  ...
  'Madhya Pradesh': {
    ...
    resourceGeography: [
      "Madhya Pradesh's wind resource is on the Malwa plateau ridges — Dhar, Ujjain, Ratlam, Shajapur and Khargone. The state's 150 m potential is 55.42 GW (NIWE / MNRE Table 7.1), materially smaller than the peninsular leaders, but sites are consistent and well-characterised.",
  ...
  'Maharashtra': {
    ...
    resourceGeography: [
      "Maharashtra's wind resource runs along the Ghats leeward ridge from Satara through Sangli and Kolhapur, and across the Deccan plateau from Dhule and Nashik into Ahmednagar. The NIWE 150 m potential is 173.87 GW (MNRE Table 7.1) — third-largest nationally. Sites range from maritime-influenced Ghats escarpments to drier inland plateaus.",
  ...
  'Rajasthan': {
    ...
    intro: "Rajasthan's Thar Desert region offers India's most consistent wind flows, driven by a thermal-low pressure system that reduces monsoon-dependence. With ~5.21 GW installed and 284.25 GW of NIWE 150 m potential, Rajasthan carries one of the largest underdeveloped RE endowments in the world.",

    resourceGeography: [
      "Rajasthan's wind corridor spans the Jaisalmer–Barmer belt, the Jodhpur plateau, and the Bikaner–Nagaur corridor. The NIWE 150 m potential is 284.25 GW (MNRE Table 7.1) — the largest state endowment nationally. Unlike peninsular states, Rajasthan's thermal-low circulation drives generation outside the monsoon season, producing one of India's least-seasonal wind regimes.",
  ...
  'Tamil Nadu': {
    ...
    resourceGeography: [
      "Tamil Nadu's wind resource is driven by two mechanisms: the Palghat gap that funnels south-west monsoon flow across the peninsula, and the leeward escarpments of the Western Ghats. NIWE places the 150 m potential at 95.11 GW (MNRE Table 7.1) — sixth-highest nationally but with very high utilisation density.",
  ...
  'Telangana': {
    ...
    resourceGeography: [
      "Telangana's wind resource is on the Deccan plateau ridgelines of the north-western districts — Narayanpet (formerly Mahabubnagar), Jogulamba Gadwal, Nizamabad and Sangareddy. NIWE places the 150 m potential at ~54.72 GW (MNRE Table 7.1) — moderate by Indian standards but well-suited to distributed generation and C&I captive.",
