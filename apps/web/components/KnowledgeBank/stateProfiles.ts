...
export const STATE_PROFILES: Record<string, StateWindProfile> = {
  ...
  'Andhra Pradesh': {
    ...
    intro: "Andhra Pradesh's rain-shadow Anantapur–Kurnool belt is among India's most productive wind terrain. With ~4.1 GW installed and 74.1 GW of 150 m NIWE potential, the state carries strong procurement momentum under APEPDCL tenders and SECI ISTS tranches.",

    resourceGeography: [
      "AP's prime corridor runs from Anantapur — one of India's driest districts — through Kurnool and into coastal Nellore. NIWE 2021 places the 150 m potential at 74.1 GW. Wind speeds in the Anantapur–Kurnool rain-shadow reach 7.5–8.5 m/s at hub height.",
  ...
  'Gujarat': {
    ...
    intro: "Gujarat leads India's wind fleet with ~12.5 GW installed — the largest state base nationally. The Kutch–Saurashtra coast delivers consistent westerlies year-round, and the Gulf of Kutch is designated India's primary offshore development zone with SECI VGF support.",

    resourceGeography: [
      "Gujarat's wind resource anchors on the Kutch–Saurashtra coastal belt and the Thar Desert margin. The NIWE 2021 150 m potential is 142.6 GW — the second-largest state endowment nationally. Kutch wind speeds regularly exceed 8 m/s at hub height; the Adani-dominated Khavda cluster hosts Class 6–7 sites.",
  ...
  'Karnataka': {
    ...
    intro: "Karnataka holds the highest 150 m wind potential of any Indian state at ~169.5 GW, yet only ~3.8% is built out. The Chitradurga–Gadag–Davangere ridgeline is India's densest wind development corridor and anchors the OEM manufacturing hub (Inox, Vestas).",

    resourceGeography: [
      "Karnataka's wind resource runs along the Deccan plateau ridgelines from Chitradurga through Gadag, Davangere and Tumkur. NIWE 2021 places the 150 m potential at 169.5 GW — the largest state endowment nationally. Best ridgeline sites record 7.5–9 m/s at hub height.",
  ...
  'Kerala': {
    ...
    policyAnchor:   'Kerala RE Policy 2021',

    intro: "Kerala's wind resource is concentrated at the Palghat gap — the same low-altitude pass that powers Tamil Nadu's strongest sites. Development is constrained by Western Ghats Eco-Sensitive Zone designations and fragmented land holdings; installed capacity is ~240 MW.",

    resourceGeography: [
      "Kerala's 150 m potential (~10 GW, NIWE 2021) focuses on the Palakkad district (Palghat gap) and high-altitude ridges of Idukki–Munnar. The gap creates a natural wind funnel with hub-height speeds of 6–8 m/s, but the best sites straddle the Kerala–Tamil Nadu border.",
    ...
    sectorProfile: [
      "State nodal: ANERT (Agency for New & Renewable Energy Research and Technology). Utility: KSEB (Kerala State Electricity Board) for both generation and distribution. KERC is the state regulator.",
      "Kerala RE Policy 2021 targets 4 GW of RE. Suzlon and Inox Wind have operational projects in Palakkad. KSEB procures limited wind through tenders and feed-in tariff orders; group-captive C&I demand remains underdeveloped.",
    ],
  ...
  'Maharashtra': {
    ...
    intro: "Maharashtra's wind resource concentrates on the leeward escarpments of the Western Ghats and the Deccan plateau. At ~5.27 GW installed it is India's fifth-largest state by capacity. MSEDCL is the most active FDRE (Firm and Dispatchable RE) utility procurer in India.",

    resourceGeography: [
      "Maharashtra's wind resource runs along the Ghats leeward ridge from Satara through Sangli and Kolhapur, and across the Deccan plateau from Dhule and Nashik into Ahmednagar. The NIWE 2021 150 m potential is 99.2 GW. Sites range from maritime-influenced Ghats escarpments to drier inland plateaus.",
  ...
  'Odisha': {
    ...
    intro: "Odisha is an early-stage wind state with ~50 MW commissioned but a NIWE-assessed 150 m potential of ~30.4 GW. GRIDCO has been actively tendering; the 480 km Bay of Bengal coastline (Paradip–Gopalpur) is under offshore feasibility study by MNRE/NIWE.",

    resourceGeography: [
      "Odisha's wind potential is distributed across the Eastern Ghats hillside districts (Kalahandi, Koraput, Bolangir) and the Bay of Bengal coastline. NIWE 2021 assesses the 150 m potential at ~30.4 GW. Wind speeds in best inland sites reach 6–7 m/s; coastal sites are marginally higher.",
  ...
  'Rajasthan': {
    ...
    intro: "Rajasthan's Thar Desert region offers India's most consistent wind flows, driven by a thermal-low pressure system that reduces monsoon-dependence. With ~5.65 GW installed and 127.8 GW of 150 m potential, Rajasthan carries one of the largest underdeveloped RE endowments in the world.",

    resourceGeography: [
      "Rajasthan's wind corridor spans the Jaisalmer–Barmer belt, the Jodhpur plateau, and the Bikaner–Nagaur corridor. The NIWE 2021 150 m potential is 127.8 GW. Unlike peninsular states, Rajasthan's thermal-low circulation drives generation outside the monsoon season, producing one of India's least-seasonal wind regimes.",
  ...
  'Tamil Nadu': {
    ...
    resourceGeography: [
      "Tamil Nadu's wind resource is driven by two mechanisms: the Palghat gap that funnels south-west monsoon flow across the peninsula, and the leeward escarpments of the Western Ghats. NIWE 2021 places the 150 m potential at 68 GW — the sixth-highest nationally but with very high utilisation density.",
  ...
  'Telangana': {
    ...
    resourceGeography: [
      "Telangana's wind resource is on the Deccan plateau ridgelines of the north-western districts — Narayanpet (formerly Mahabubnagar), Jogulamba Gadwal, Nizamabad and Sangareddy. NIWE 2021 places the 150 m potential at approximately 9.8 GW — modest in absolute terms but well-suited to distributed generation and C&I captive.",
  ...
  'Himachal Pradesh': {
    ...
    resourceGeography: [
      "HP's 150 m potential — estimated at ~25 GW by NIWE — concentrates in the upper Spiti, Kinnaur and Chamba ridge systems above 3,000 m, with mean speeds of 5.5–7.5 m/s. These sites face significant logistical challenges for heavy equipment transport.",
